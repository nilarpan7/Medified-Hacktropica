document.addEventListener('DOMContentLoaded', function() {
    ...
    navItems.forEach(item => {
        item.addEventListener('click', function() {
            ...
            // Special initialization for video call section
    ...
    function initializeVideoCall() {
        const callTimer = document.querySelector('.call-timer span');
        const controlButtons = document.querySelectorAll('.control-btn');
        
        // Toggle mic/video buttons
        controlButtons.forEach(btn => {
            if (btn.classList.contains('mic') || btn.classList.contains('video')) {
        ...
        // End call button
        document.querySelector('.control-btn.end-call').addEventListener('click', function() {
            alert('Call ended');
        ...
        // Clean up interval when leaving the section
    ...
    buttons.forEach(btn => {
        btn.addEventListener('mouseenter', function() {
            if (this.classList.contains('btn-primary')) {
                ...
                this.style.boxShadow = '0 4px 12px rgba(124, 77, 255, 0.2)';
            }
        });
    ...
    // Card hover effects
    const cards = document.querySelectorAll('.stat-card, .upcoming-appointments, .appointments-container, .profile-container');
    cards.forEach(card => {
    ...
    const avatars = document.querySelectorAll('.pulse-animation');
